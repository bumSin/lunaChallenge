...
def getCandidateInfoList(requireOnDisk_bool=True):
	...
	with open('data/annotations.csv', "r") as f:
		for row in list(csv.reader(f))[1:]:       #skipping first row as it is column names
			series_uid = row[0]
...
class Ct:
	...
	#Extracting a nodule from CT scan
	#It takes center expressed as patient coordinate system, just as expressed in luna csv data, as well as width in voxels
	#It returns a cubic chunk of CT as well as center converted in array coordinates
